    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        val gradientBrush = remember(animatedDominantColor) {
            Brush.radialGradient(
                colorStops = arrayOf(
                    0.00f to animatedDominantColor.copy(alpha = 0.95f),
                    0.05f to animatedDominantColor.copy(alpha = 0.90f),
                    0.10f to animatedDominantColor.copy(alpha = 0.84f),
                    0.15f to animatedDominantColor.copy(alpha = 0.76f),
                    0.20f to animatedDominantColor.copy(alpha = 0.68f),
                    0.25f to animatedDominantColor.copy(alpha = 0.58f),
                    0.30f to animatedDominantColor.copy(alpha = 0.48f),
                    0.35f to animatedDominantColor.copy(alpha = 0.40f),
                    0.40f to animatedDominantColor.copy(alpha = 0.32f),
                    0.45f to animatedDominantColor.copy(alpha = 0.25f),
                    0.50f to animatedDominantColor.copy(alpha = 0.19f),
                    0.55f to animatedDominantColor.copy(alpha = 0.14f),
                    0.60f to animatedDominantColor.copy(alpha = 0.10f),
                    0.70f to animatedDominantColor.copy(alpha = 0.06f),
                    0.80f to animatedDominantColor.copy(alpha = 0.03f),
